...
Default taxes set in orders and invoices come from each product's Invoicing tab. Such taxes are used when you sell to companies
that are in the same country/state than you.

.. image:: media/application05.png
   :align: center

To change the default taxes set for any new product created go to :menuselection:`Invoicing/Accounting --> Configuration --> Settings`.
