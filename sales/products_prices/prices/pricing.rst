...
Have the pricing strategy tailored to your business, with specific prices and discounts per quantity, period, currency or customer segment. Odoo has an integrated tool to set and compute sales prices, the so-called Pricelists.
...
To apply several prices per product, select *Different prices per customer segment* in :menuselection:`Sales --> Settings`. Then open the *Sales* tab in the product detail form. You can settle following strategies.
...
.. tip:: Make sure you have default prices set in the pricelist outside of the deals period. Otherwise you might have issues once the period over.
...
.. note:: The prices order does not matter. The system is smart and applies first prices that match the order date and/or the minimal quantities.

Discounts, margins, roundings
==============================

The third option allows to apply discounts % or amounts, margins and rounding based on formulas
Once installed go to  :menuselection:`Sales --> Configuration --> Pricelists` (or  :menuselection:`Website Admin --> Catalog --> Pricelists` if you use e-Commerce).
