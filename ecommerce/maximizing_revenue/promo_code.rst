...
* Go to :menuselection:`Sales --> Settings` and choose *Advanced pricing based on formula* for *Sale Price*.
* Go to :menuselection:`Website Admin --> Catalog --> Pricelists` and create a new pricelist with the discount rule (see :doc:`../managing_products/pricelists`). Then enter a code.
