============================
How to configure cross-selling
============================
...
.. note:: There is an algorithm to figure out the best accessories to display in case several items are added to cart. If any item is the accessory of several products added to cart, it is most likely that it will be atop the list of suggested accessories.
...
.. note:: The quantity of optional items added to cart is the same than the main item.
