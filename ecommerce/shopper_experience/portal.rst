...
When clicking the link in the email or when clicking *Sign up* in the checkout process, your customer is directed to the *Sign up* page.
...
.. note:: If a portal user is a contact of a company (*Company* field set in customer detail form), this last will see all the documents of the company and all its other contacts through the portal.
